 ...
 */
public abstract class CusBaseBubblePopup<T extends CusBaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public CusBaseBubblePopup(Context context) {
        super(context);
        mWrappedView = onCreateBubbleView();
        init();
    }

    public CusBaseBubblePopup(Context context, View wrappedView) {
        super(context);
    ...
    public void setUiBeforShow() {
        mLlContent.setBackgroundResource(co.newapp.R.drawable.shadow_check_work);
